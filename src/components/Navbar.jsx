...
export default function Navbar() {
  ...
  return (
    <nav className="bg-[#256b67] text-white px-6 py-4 flex justify-between items-center w-full fixed top-0 z-50">
      <div className="flex items-center space-x-2 sm:ml-2 md:ml-5 lg:ml-10">
        <Link to="/" onClick={() => window.scrollTo(0, 0)} className="flex items-center space-x-2">
            ...
            <h1 className="text-2xl font-bold font-poppins">
                <span className="text-[#66dff5]">Medi</span>
                <span className="text-[#9deab4]">Track</span>
            </h1>
        </Link>
      </div>
      ...
      <div className="hidden md:flex space-x-6 items-center lg:mr-10 md:mr-5 sm:mr-2">
        ...
        <Link to="/login" className="bg-[#66dff5] text-[#115456] px-4 py-2 rounded hover:bg-[#9deab4] font-semibold">
          Login Now
        </Link>
      </div>
      ...
      {isOpen && (
        <div className="absolute top-16 left-0 w-full bg-[#256b67] text-white flex flex-col space-y-4 p-4 md:hidden">
          ...
          <Link
            to="/login"
            className="bg-[#66dff5] text-[#115456] px-4 py-2 rounded hover:bg-[#9deab4] font-semibold text-center"
